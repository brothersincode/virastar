/*!
* Virastar - v0.20.0-dev - 2020-03-23
  ...
  Virastar.prototype = {
    ...
    cleanup: function cleanup (text, options) {
      ...
      if (opts.preserve_URIs) {
        ...
        text = text.replace(new RegExp(pattern, 'g'), function (matched) {
          uris.push(matched);
    ...
    // props @zoghal
    // NOTE: possible bug: some suffixes could be nouns
    fixSuffixSpacing: function fixSuffixSpacing (text, options) {
      return text
        ...
        .replace(/ ((ام|ات|اش|ای|اید|ایم|اند|مان|تان|شان)[\s.,;،؛!؟?"'()[\]{}“”«»])/g, '\u200c$1')
        // *tar *tari *tarin
