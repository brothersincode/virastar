...
(function (name, global, definition) {
  ...
  Virastar.prototype = {
    ...
    entities: {
      ...
      'apos;': '\'',
      'QUOT;': '"',
      'QUOT': '"', // eslint-disable-line quote-props
      'quot;': '"',
      'quot': '"', // eslint-disable-line quote-props
      'zwj;': '\u200d',
      'ZWNJ;': '\u200c',
    ...
    charBatchReplace: function charBatchReplace (text, fromBatch, toBatch) {
    ...
    fixEnglishNumbers: function fixEnglishNumbers (text, options) {
      return this.charBatchReplace(text, '1234567890', '۱۲۳۴۵۶۷۸۹۰');
    },

    fixArabicNumbers: function fixArabicNumbers (text, options) {
      return this.charBatchReplace(text, '١٢٣٤٥٦٧٨٩٠', '۱۲۳۴۵۶۷۸۹۰');
    },

    fixPunctuations: function fixPunctuations (text, options) {
      return this.charBatchReplace(text, '%,;', '٪،؛');
    },
